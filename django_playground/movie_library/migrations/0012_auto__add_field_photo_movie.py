...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Photo.movie'
        db.add_column(u'movie_library_photo', 'movie',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['movie_library.Movie']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Photo.movie'
        db.delete_column(u'movie_library_photo', 'movie_id')
