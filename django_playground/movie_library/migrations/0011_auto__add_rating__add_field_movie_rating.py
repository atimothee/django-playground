...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Rating'
        db.create_table(u'movie_library_rating', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('explanation', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal(u'movie_library', ['Rating'])

        # Adding field 'Movie.rating'
        db.add_column(u'movie_library_movie', 'rating',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['movie_library.Rating'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Rating'
        db.delete_table(u'movie_library_rating')

        # Deleting field 'Movie.rating'
        db.delete_column(u'movie_library_movie', 'rating_id')
